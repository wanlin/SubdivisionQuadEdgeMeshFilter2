...
#ifndef __itkTriangleAreaCellSubdivisionCriterion_h
#define __itkTriangleAreaCellSubdivisionCriterion_h

#include "itkQuadEdgeMeshCellSubdivisionCriterion.h"
...
class TriangleAreaCellSubdivisionCriterion : public QuadEdgeMeshCellSubdivisionCriterion< TMesh >
{
public:
  typedef TriangleAreaCellSubdivisionCriterion            Self;
  typedef QuadEdgeMeshCellSubdivisionCriterion< TMesh >   Superclass;
  ...
  itkTypeMacro(TriangleAreaCellSubdivisionCriterion, Object);
  itkNewMacro(Self);
...
protected:
  TriangleAreaCellSubdivisionCriterion(){m_MaximumArea = NumericTraits< CoordRepType >::max();}
  ~TriangleAreaCellSubdivisionCriterion(){}
...
#include "itkTriangleAreaCellSubdivisionCriterion.hxx"
#endif
