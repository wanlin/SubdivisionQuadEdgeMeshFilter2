...
#ifndef __itkEdgeLengthEdgeCellSubdivisionCriterion_h
#define __itkEdgeLengthEdgeCellSubdivisionCriterion_h

#include "itkQuadEdgeMeshEdgeCellSubdivisionCriterion.h"
...
class EdgeLengthEdgeCellSubdivisionCriterion : public QuadEdgeMeshEdgeCellSubdivisionCriterion< TMesh >
{
public:
  typedef EdgeLengthEdgeCellSubdivisionCriterion              Self;
  typedef QuadEdgeMeshEdgeCellSubdivisionCriterion< TMesh >   Superclass;
  ...
  itkTypeMacro(EdgeLengthEdgeCellSubdivisionCriterion, Object);
  itkNewMacro(Self);
...
protected:
  EdgeLengthEdgeCellSubdivisionCriterion(){ m_MaximumLength = NumericTraits< CoordRepType >::max(); }
  ~EdgeLengthEdgeCellSubdivisionCriterion(){}
...
#include "itkEdgeLengthEdgeCellSubdivisionCriterion.hxx"
#endif
