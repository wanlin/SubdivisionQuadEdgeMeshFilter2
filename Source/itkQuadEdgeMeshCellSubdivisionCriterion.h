...
#ifndef __itkQuadEdgeMeshCellSubdivisionCriterion_h
#define __itkQuadEdgeMeshCellSubdivisionCriterion_h
...
class ITK_EXPORT QuadEdgeMeshCellSubdivisionCriterion : public Object
{
public:
  typedef QuadEdgeMeshCellSubdivisionCriterion   Self;
  ...
  itkTypeMacro(QuadEdgeMeshCellSubdivisionCriterion, Object);

  void Compute(MeshType * mesh, CellIdContainer & cellIds);

protected:
  QuadEdgeMeshCellSubdivisionCriterion(){}
  ~QuadEdgeMeshCellSubdivisionCriterion(){}
};
